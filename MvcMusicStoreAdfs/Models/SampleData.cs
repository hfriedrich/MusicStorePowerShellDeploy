...
namespace MvcMusicStoreAdfs.Models
{
    public class SampleData 
    {
        ...
        private readonly IPersistArtists _artistPersister;
        private readonly IPersistGenres _genrePersister;

        public SampleData(IPersistAlbums albumPersister, IPersistArtists artistPersister, IPersistGenres genrePersister)
        {
            _albumPersister = albumPersister;
            _artistPersister = artistPersister;
            _genrePersister = genrePersister;
        }
        ...
        public void Seed()
        {
            ...
            _albumPersister.Store(albums);
            _genrePersister.Store(genres);
            _artistPersister.Store(artists);
        }
    }
}